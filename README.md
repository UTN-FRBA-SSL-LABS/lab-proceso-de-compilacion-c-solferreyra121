...
> **R:** Por que incluye todas las directivas como stdio.h, stdlib.h o matematica.h y las escribe directamente en el archivo lo que hace que aumente el numero de lineas.
...
> **R:** El prepocesador asi como incluye las directivas del archivo .c, ademas elimina todas las lineas de comentario de este mismo.
...
> **R:** Para el primero no sale nada en consola y para el segundo sale: printf("[DEBUG] %s\n", ("Iniciando main"));
...
> **R:**Esas lineas informan de donde pertenece el bloque que estan marcando, te dice el numero de linea y de que archivo proviene. El bloque que contiene la declaracion de `printef` proviene de archivo "C:/msys64/mingw64/include/stdio.h"
...
> **R:**Por que en area_circulo no esta definido en el programa.o pero se necesita entonces es U (indefinido), en matematica.o esta definido area_circulo y aparece con una T (texto ejecutable).
...
> **R:** 000000014000a870 r .rdata$.refptr.__RUNTIME_PSEUDO_RELOC_LIST__
000000014000a860 r .rdata$.refptr.__RUNTIME_PSEUDO_RELOC_LIST_END__
000000014000a830 r .rdata$.refptr._MINGW_INSTALL_DEBUG_MATHERR
000000014000a870 R .refptr.__RUNTIME_PSEUDO_RELOC_LIST__
000000014000a860 R .refptr.__RUNTIME_PSEUDO_RELOC_LIST_END__
000000014000a830 R .refptr._MINGW_INSTALL_DEBUG_MATHERR
000000014000b2f0 R ___RUNTIME_PSEUDO_RELOC_LIST__
000000014000b2f0 R ___RUNTIME_PSEUDO_RELOC_LIST_END__
                 U __end__
000000014000f228 I __imp_SetUnhandledExceptionFilter
000000014000b2f0 R __RUNTIME_PSEUDO_RELOC_LIST__
000000014000b2f0 R __RUNTIME_PSEUDO_RELOC_LIST_END__
0000000140009040 D _MINGW_INSTALL_DEBUG_MATHERR
0000000140008c58 T SetUnhandledExceptionFilter
000000014000e0c0 b stUserMathErr
...
> **R:** quedan porque son parte de la biblioteca dinamica y se cargan cuando se ejecuta, luego el cargador dinamico las resuelve a la hora de ejecutar.
